...
export default function BrewingScreen() {
  ...
  const handlePrepareToBrew = () => {
    if (!scaleConnected || !kettleConnected) {
      Alert.alert(
        "Connection Required",
        "Please connect both scale and kettle before brewing."
      );
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Header - Simple centered title like Equipment page */}
        ...
        <View style={styles.brewingDiagram}>
          ...
          <View style={styles.extractionContainer}>
            ...
            <Text style={styles.extractionValue}>
              {extraction.weight.toFixed(1)}g
            </Text>
            <Text style={styles.extractionRate}>
              {extraction.rate.toFixed(1)}g/s
            </Text>
          </View>
          ...
          <View style={styles.waterContainer}>
            ...
            <Text style={styles.waterValue}>
              {waterWeight.weight.toFixed(1)}g
            </Text>
            <Text style={styles.waterRate}>
              {waterWeight.rate.toFixed(1)}g/s
            </Text>
          </View>
